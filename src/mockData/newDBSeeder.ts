...
export default async function seed() {
  ...
  const seedFeedback = async () => {
    ...
    const feedbacks = [
      { subject: "Session Feedback", name: "John Doe", email: "john@example.com", message: "Great session!" },
      { subject: "Challenge Feedback", name: "Jane Smith", email: "jane@example.com", message: "Very helpful!" },
      { subject: "General Feedback", name: "Mike Ross", email: "mike@example.com" }, // No message (optional)
      { subject: "App Feedback", name: "Sara Connor", email: "sara@example.com", message: "Loved the challenge!" },  
    ];
