...
export default async function go() {
  ...
  const cardData = {
    ...
    support: {
      ...
      content:
        'Share your progress in the group chat and receive encouragement.',
    },
    share: {
  ...
  await ChallengeModel.findByIdAndUpdate('665739933ccf2b71c3eb3e92', {
    $push: { cards: allCards },
  });
  ...
  await ActiveChallengeModel.findByIdAndUpdate('6656df1b8437151db0cce584', {
    $push: { cards: activeCards },
  });
  console.log('###########  DONE  #########');
}
